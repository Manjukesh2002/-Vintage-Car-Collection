...
const carDetails = async (client) => {
    //Fetches records from given database
    const cursor = await client.db("CarsDB").collection("Cars").find({});
...
http.createServer(async (req, res) => {
    if (req.url === "/api") {
        const URL = "mongodb+srv://manjukeshp11:manjuponguluru@carscluster.hbr2o.mongodb.net/?retryWrites=true&w=majority&appName=CarsCluster";
        ...
        try {
            ...
            const carsData = await carDetails(client);
            // Handling CORS Issue
        ...
        const mediaType = mediaTypes[fileExtension] || "application/octet-stream";
